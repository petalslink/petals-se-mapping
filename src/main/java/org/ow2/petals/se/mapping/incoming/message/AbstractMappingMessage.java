...
/**
 * An abstract mapping operation extracted from WDSL according to BC Mail annotations
 * 
 * @author Christophe DENEUX - Linagora
 * 
 */
public abstract class AbstractMappingMessage implements MappingMessage {
