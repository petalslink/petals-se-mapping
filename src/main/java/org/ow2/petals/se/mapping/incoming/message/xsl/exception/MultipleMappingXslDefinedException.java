 ...
 * 
 */
public class MultipleMappingXslDefinedException extends InvalidAnnotationForMessageException {

    private static final long serialVersionUID = 2146748396977435879L;

    private static final String MESSAGE = "Several SE mapping annotations defining the use of a XSL style-sheet are declared";

    public MultipleMappingXslDefinedException(final QName wsdlOperation, final String messageName) {
