...
public class MonitTraceFilteringRule {
    ...
    public void setCompEnableFlowTracing(final String compEnableFlowTracing) {
        this.compEnableFlowTracing = compEnableFlowTracing;
    }

    public void setCompEnableFlowTracingPropagation(final String compEnableFlowTracingPropagation) {
        this.compEnableFlowTracingPropagation = compEnableFlowTracingPropagation;
    }

    public void setProvEnableFlowTracing(final String provEnableFlowTracing) {
        this.provEnableFlowTracing = provEnableFlowTracing;
    }
    ...
    public void setIsConsMonitTraceLogged(final String isConsMonitTraceLogged) {
        this.isConsMonitTraceLogged = isConsMonitTraceLogged;
    }
